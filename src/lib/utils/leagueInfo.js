/*   STEP 1   */
export const leagueID = "1312130532338827264"; // your league ID
export const leagueName = "Dynasty Dads 1"; // your league name
...
export const homepageText = `
  ...
  This gives power to the individual leagues and owners to make each league unique.</p>

  <p>If there is something you want to bring up for a vote feel free, at the conclusion of every season pretty much everything is fair game. 
